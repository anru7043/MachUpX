...
$ python -m machupX AMDwing_input.json
"""
...
if __name__=="__main__":
    ...
    print(json.dumps(FM_results["AMD_wing"]["total"], indent=4))
    ...
    print(json.dumps(trim_state["AMD_wing"], indent=4))

    # Now that we're trimmed, let's see what our aerodynamic derivatives are.
    derivs = my_scene.derivatives()
    print(json.dumps(derivs["AMD_wing"], indent=4))

    # export geometry
    my_scene.export_stl(filename = "AMD_wing.stl")
    my_scene.export_dxf(aircraft = "AMD_wing")